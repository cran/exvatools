...
# Individual
exvadec <- make_exvadec(wio, exporter = "ESP", method = "bm_snk",
                        output = "standard")
...
exvadec <- make_exvadec(wio, exporter = "CHN", method = "bm_snk",
                        output = "standard")
...
exvadec <- make_exvadec(wio, exporter = "NAFTA", method = "bm_snk",
                        output = "standard")
...
exvadec <- make_exvadec(wio, exporter = "all", method = "bm_snk",
                        output = "standard")
